...
plot(x,y,ylim=c(0,9),xlim=c(0,65),pch=19,xlab="Rechnungsbetrag x",ylab="Trinkgeld y")
...
dev.set(3)
par(mar=c(4,4,1,1))
truehist(alphadach[1],xlim=c(-2.5,3),ylim=c(0,150),breaks=seq(-2.5,3,length=21),prob=F,main="",xlab=expression(hat(alpha)))
dev.set(4)
par(mar=c(4,4,1,1))
truehist(betadach[1],xlim=c(0.02,0.16),ylim=c(0,150),breaks=seq(0.02,0.18,length=21),prob=F,main="",xlab=expression(hat(beta)))
dev.set(2)
locator(1)
...
for (i in 2:1000)
  ...
  if(i>0) 
    ...
    dev.set(3)
    par(mar=c(4,4,1,1))
    truehist(alphadach[1:i],xlim=c(-2.5,3),ylim=c(0,150),breaks=c(-99,seq(-2.5,3,length=21),99),prob=F,main="",xlab=expression(hat(alpha)))
    }
  if(i>2)
    {
    dev.set(4)
    par(mar=c(4,4,1,1))
    truehist(betadach[1:i],xlim=c(0.02,0.16),ylim=c(0,150),breaks=c(-99,seq(0.02,0.18,length=21),99),prob=F,main="",xlab=expression(hat(beta)))
    }
  }


# Verteilung der beiden Schätzer
